...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (profileForm && formMessage) {
        profileForm.addEventListener('submit', (event) => {
            ...
            formMessage.textContent = 'Formulario enviado correctamente. Gracias por consultar mi perfil.';
        });
    ...
    /* ============================================
       8. PARTÍCULAS FLOTANTES (COLORES MASCULINOS)
    ============================================ */
    ...
    /* ============================================
         9. GENERACIÓN DE PDF LIMPIO Y COMPLETO
    ============================================ */
            ...
            exportNode.innerHTML = `
                ...
                <div class="pdf-sheet">
                    <div class="pdf-header">
                        <img class="pdf-photo" src="archivos/Archivos%20fotoportada.jpeg" alt="Foto de perfil">
                    ...
                    <div class="pdf-section">
                        ...
                        <div class="pdf-item">
                            ...
                            <div class="pdf-actions">
                                <a class="pdf-link" href="archivos/Archivos%20diploma%20de%20bachiller.pdf">Ver diploma académico</a>
                            </div>
                        </div>
                        <div class="pdf-item">
                            ...
                            <div class="pdf-actions">
                                <a class="pdf-link" href="archivos/Archivos%20Tecnico%20en%20nomina%20y%20prestaciones%20sociales.pdf">Ver certificado</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pdf-section">
                        ...
                        <div class="pdf-contact">
                            <img src="archivos/Archivos%20logo%20de%20telefono.jpeg" alt="Teléfono">
                            <div>
                        ...
                        <div class="pdf-contact">
                            <img src="archivos/Archivos%20logo%20de%20correo.jpeg" alt="Correo">
                            <div>
